...
const nextConfig: NextConfig = {
  ...
  // @gradio/client：截图转 TikZ 调 HF DeTikZify Space 的客户端，含 node/browser 条件导出，不内联更稳。
  serverExternalPackages: ['@sparticuz/chromium', 'playwright-core', 'node-tikzjax', '@gradio/client'],
  ...
  experimental: {
    serverActions: {
      // 多套试卷 + 内嵌 SVG 几何图，以及 /studio LaTeX 编译的附件（图片/.sty）易破默认 1MB 上限
      bodySizeLimit: '25mb',
    },
  },
};
